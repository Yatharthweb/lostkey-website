<?php
$pageTitle = "Lost or Stolen Car Keys - Insurance Claims | Lostkey";
$pageDescription = "Got lost or stolen car keys in Auckland? We provide key replacement & itemised receipts to claim through your car insurance policy.";
$currentPage = "insurance-claims";
...
function InsuranceHtmlPage() {
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-gray-900 relative pb-16 md:pb-0" style={{ fontFamily: "'Inter Tight', 'Inter', sans-serif" }}>
      ...
      {/* UNIFIED STICKY HEADER */}<HeaderComponent currentPage="insurance-claims" />{/* PAGE HERO */}
