        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center h-20">
          ...
          <div className="hidden lg:flex items-center space-x-12">
            <div className="flex space-x-8 text-[15px] font-bold tracking-wide h-full items-center">
              ...
              <a 
                href="about-us.php" 
                className={currentPage === 'about' ? 'text-[#F4C430] font-extrabold border-b-2 border-[#F4C430] py-6' : 'text-white hover:opacity-80 transition py-6'}
              >
                About Us
              </a>
                ...
                <div className="absolute top-[80px] left-1/2 -translate-x-1/2 w-[850px] bg-white opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 shadow-[0_30px_60px_rgba(0,0,0,0.15)] rounded-2xl p-8 border-t-[4px] border-[#F4C430] cursor-default z-50">
                  <div className="grid grid-cols-3 gap-x-8 gap-y-6">
                    {MAIN_SERVICES.map((service, idx) => (
                      <a 
                        key={idx} 
                        href={service.name === 'Automotive Locksmith Auckland' ? 'automotive-locksmith-auckland.php' : service.name === 'Residential Locksmith Auckland' ? 'residential-locksmith-auckland.php' : service.name === '24 Hour Locksmith Auckland' ? '24-hour-locksmith-auckland.php' : 'index.php#contact'} 
